...
export default function HeroSection({}: Props) {
  return (
    <section className="bg-hero-bg bg-cover bg-center bg-no-repeat bg-[#3B3B3B] text-white text-center h-[80vh] md:h-[584px] w-full flex gap-8 justify-center flex-col items-center px-4">
